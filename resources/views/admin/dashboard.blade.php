                    ...
                    <div class="bg-green-50 dark:bg-green-900/20 p-6 rounded-lg">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-gray-600 dark:text-gray-400">View system statistics</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-purple-50 dark:bg-purple-900/20 p-6 rounded-lg">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-gray-600 dark:text-gray-400">System configuration</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-orange-50 dark:bg-orange-900/20 p-6 rounded-lg">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-gray-600 dark:text-gray-400">Generate reports</p>
                            </div>
                        </div>
                    </div>
                </div>
